    ...
    return (
        <Fragment>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => user.actionHandler(user._id, "edit")}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => user.actionHandler(user._id, "delete")}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => user.actionHandler(user._id, "info")}>
